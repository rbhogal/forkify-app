...
const showRecipe = async function () {
  try {
    ...
    console.log(id);
    if (!id) return; // 1) Loading recipe / Loading spinner
...
['hashchange', 'load'].forEach(ev => window.addEventListener(ev, showRecipe)); // Better Way of doing event listeners for both ^^^
